Ext.define('WinWithin.view.Main', {
    ...
    initialize: function() {
        ...
        var component = {
            ...
            items: [
            {
                ...
                html: [
                    '<p><strong>Anv&auml;ndarvillkor och avtal g&auml;llande denna mobilapplikation.</strong></p>'
    +'<p><strong>1. Allm&auml;nna villkor och best&auml;mmelser</strong></p><p>Applikationen riktar sig mot myndiga fysiska personer. '
    ...
    +'s&auml;tt anv&auml;ndas inom professionell/kommersiell verksamhet.</p><p><strong>2. Win Withins &auml;gander&auml;tt</strong></p>'
    ...
    +'<p><strong>3. Ansvarsbegr&auml;nsning&nbsp;</strong></p><p>S&aring; l&aring;ngt inte annat f&ouml;ljer av tvingande lag ansvarar Win Within inte '
    ...
    +'<p><strong>4. F&ouml;r&auml;ndring av tj&auml;nst och avtalets f&ouml;rtida upph&ouml;rande</strong></p><p>Win Within kan ensidigt &auml;ndra dessa '
    ...
    +'villkoren att g&auml;lla.</p><p><strong>5. Tvist&nbsp;</strong></p><p>Eventuell Tvist i anledning av detta avtal skall slutligt avg&ouml;ras genom '
    +'svensk domstol med svensk lag som utg&aring;ngspunkt.</p><p>&nbsp;</p><p><strong>6. Kontaktuppgifter</strong></p><p>Win Within</p><p>Box 38091</p>'
