    ...
    initialize: function() {
        ...
        var topToolbar = {
            ...
            },
            {
                ...
                handler: this.play,
                scope: this,
                html: '<img name="kap1Play" class="play-button" src="resources/images/ic_action_play.png" style="width:36px;"/>',
                iconMask: true
            }
            ]
        };
        var bottomToolbar = {
            ...
            items: [
            {
                ...
                handler: this.play,
                scope: this,
                html: '<img name="kap1Play" class="bottom-play-button" src="resources/images/play.png" style="width:48px;" />',
                iconMask: true
            }
            ]
        };
